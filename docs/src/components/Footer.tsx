        ...
        <Container paddingY="6" maxWidth="container.lg">
            <Grid templateColumns={['1fr', null, 'repeat(4, 1fr)']}>
                ...
                <FooterSection heading="Repository">
                    <FooterLink
                        href="https://github.com/sidharthv96/playwright-report-action"
                        label="GitHub"
                    />
                    <FooterLink
                        href="https://github.com/sidharthv96/playwright-report-action/issues"
                        label="Issues"
                    />
                    <FooterLink
                        href="https://github.com/sidharthv96/playwright-report-action/releases"
                        label="Releases"
                    />
                    <FooterLink
